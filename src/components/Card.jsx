...
const Card = ({ item }) => {
  return (
    ...
    >
      <p className="text-darkGrey font-satoshi font-medium text-xl mt-1">
        {item.date}
      </p>
      <p className="text-darkGrey font-satoshi text-2xl font-bold capitalize mt-6">
        {item.condition}
      </p>
      ...
      <div className="flex justify-between items-center">
        <p className="text-offWhite font-satoshi font-medium text-lg mt-7">
          Real Feel {getTemp(item).feels_like.toFixed(1)}&deg;{" "}
        </p>
        <p className="text-offWhite font-satoshi font-medium text-lg mt-5">
